...
*/
const lowerCase = [];
let lowerCaseAnimals = zooAnimals.map((lowerCaseNames) => {
...
*/
const populationTotal = zooAnimals.reduce((totalPopulation, eachAnimalPopulation) => {
  return totalPopulation + eachAnimalPopulation.population;
}, 0);
